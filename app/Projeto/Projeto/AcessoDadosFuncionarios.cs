...
namespace Projeto
{
    public partial class AcessoDadosFuncionarios : Form
    {
        public AcessoDadosFuncionarios()
        {
            InitializeComponent();
        }
        ...
        {
            var acessofuncionariosInicial = new MainPage();
            acessofuncionariosInicial.Show();
            this.Hide();
        }
